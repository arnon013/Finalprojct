...
class MainProduct extends Component {
  ...
  onFormSubmit(data) {
    ...
    if(this.state.isEditProduct){
      apiUrl = 'http://localhost/signalinfo/index.php/reactapi/editProduct';
    } else {
      apiUrl = 'http://localhost/signalinfo/index.php/reactapi/createProduct';
    }
  ...
  editProduct = productId => {
    ...
    const apiUrl = 'http://localhost/signalinfo/index.php/reactapi/getProduct';
