    ...
    return (
      <div id="page-wrapper">
        ...
        <div className="row">
          <div className="col-lg-4">
            <div className="panel panel-default">
              <div className="panel-heading">Headings</div>
            ...
            <div className="panel panel-default">
              ...
              <div className="panel-body">
                ...
                <p>
                  ...
                  example of <a>link anchor text</a> within body copy.
                </p>
                <p>
          ...
          <div className="col-lg-4">
            <div className="panel panel-default">
              <div className="panel-heading">Emphasis Classes</div>
              <div className="panel-body">
        ...
        <div className="row">
          <div className="col-lg-4">
            <div className="panel panel-default">
              <div className="panel-heading">Abbreviations</div>
              <div className="panel-body">
                <p>
          ...
          <div className="col-lg-4">
            <div className="panel panel-default">
              <div className="panel-heading">Blockquotes</div>
              <div className="panel-body">
          ...
          <div className="col-lg-4">
            <div className="panel panel-default">
              <div className="panel-heading">Lists</div>
              <div className="panel-body">
        ...
        <div className="row">
          <div className="col-lg-4">
            <div className="panel panel-default">
              <div className="panel-heading">Description Lists</div>
              <div className="panel-body">
                <dl>
