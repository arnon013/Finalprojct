        ...
        <div className="row">
          <div className="col-lg-12">
            <div className="panel panel-default">
              <div className="panel-heading">Basic Form Elements</div>
                  ...
                  <div className="col-lg-6">
                    ...
                    <form role="form">
                      <div className="form-group has-success">
                        <label className="control-label" for="inputSuccess">
                          Input with success
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="form-group has-warning">
                        <label className="control-label" for="inputWarning">
                          Input with warning
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="form-group has-error">
                        <label className="control-label" for="inputError">
                          Input with error
                        </label>
                        <input
                          type="text"
