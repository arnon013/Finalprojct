          ...
          <div className="col-lg-12">
            <div className="panel panel-default">
              <div className="panel-body">
                ...
                <p>
                  Grid classes apply to devices with screen widths greater than
                  or equal to the breakpoint sizes, and override grid classes
                  targeted at smaller devices. Therefore, applying any
                  <code>.col-md-</code> class to an element will not only affect
            ...
            <div className="panel panel-default">
              <div className="panel-body">
                ...
                <p>
                  ...
                  <code>.col-md-*</code> grid classes, you can create a default
            ...
            <div className="panel panel-default">
              <div className="panel-body">
                ...
                <p>
                  ...
                  <code>.col-xs-*</code>
                  <code>.col-md-*</code> to your columns. See the example below
          ...
          <div className="col-lg-12">
            <div className="panel panel-default">
              <div className="panel-body">
                ...
                <p>
                  Build on the previous example by creating even more dynamic
                  and powerful layouts with tablet
          ...
          <div className="col-lg-12">
            <div className="panel panel-default">
              <div className="panel-body">
                ...
                <p>
                  With the four tiers of grids available you're bound to run
                  into issues where, at certain breakpoints, your columns don't
                  clear quite right as one is taller than the other. To fix
                  that, use a combination of a<code>.clearfix</code> and our{" "}
                  <a href="#responsive-utilities">responsive utility classes</a>
                  .
                </p>
                <div className="row show-grid">
                  <div className="col-xs-6 col-sm-3">
                    .col-xs-6 .col-sm-3
                    <br />
                    Resize your viewport or check it out on your phone for an
                    example.
                  </div>
            ...
            <div className="panel panel-default">
              <div className="panel-body">
                ...
                <p>
                  ...
                  <code>.col-md-offset-*</code> classes. These classes increase
            ...
            <div className="panel panel-default">
              <div className="panel-body">
                ...
                <p>
                  ...
                  <code>.col-md-*</code> column. Nested rows should include a
